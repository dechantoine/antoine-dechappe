...
import { byDateAndAlphabetical, BookmarksList, SortFn } from "../BookmarksList"
...
interface BookmarksContentOptions {
  /**
...
const defaultOptions: BookmarksContentOptions = {
  showFolderCount: false,
  showSubfolders: true,
}

export default ((opts?: Partial<BookmarksContentOptions>) => {
  const options: BookmarksContentOptions = { ...defaultOptions, ...opts }

  const BookmarksContent: QuartzComponent = (props: QuartzComponentProps) => {
  ...
  BookmarksContent.css = style + BookmarksList.css
